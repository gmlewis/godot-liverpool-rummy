	...
	var test_cases = [
		{
			...
			'input': ['5-hearts-0', '6-hearts-0', '7-hearts-0', '8-hearts-0'],
			'expected': ['5-hearts-0', '6-hearts-0', '7-hearts-0', '8-hearts-0'],
		},
		{
			'name': 'Joker should fill the gap between 3 and 5',
			'input': ['2-hearts-0', '3-hearts-0', 'JOKER-1-0', '5-hearts-0', '6-hearts-0'],
			'expected': ['2-hearts-0', '3-hearts-0', 'JOKER-1-0', '5-hearts-0', '6-hearts-0'],
		},
		{
			'name': 'Ace should be positioned as low when it creates fewer gaps',
			'input': ['A-hearts-0', '2-hearts-0', '3-hearts-0', '4-hearts-0'],
			'expected': ['A-hearts-0', '2-hearts-0', '3-hearts-0', '4-hearts-0'],
		},
		{
		...
		},
		{
			...
			'input': ['A-hearts-0', 'JOKER-1-0', '3-hearts-0', '4-hearts-0'],
		...
		},
		{
			...
			'input': ['JOKER-1-0', '2-hearts-0', '3-hearts-0', '4-hearts-0'],
		...
		},
		{
			...
			'input': ['4-hearts-0', 'JOKER-1-0', '6-hearts-0', '7-hearts-0'],
			'expected': ['4-hearts-0', 'JOKER-1-0', '6-hearts-0', '7-hearts-0'],
		},
		{
			'name': 'Bug example 1 should be fixed',
			'input': ['6-hearts-0', '7-hearts-0', '8-hearts-0', '5-hearts-0'],
			'expected': ['5-hearts-0', '6-hearts-0', '7-hearts-0', '8-hearts-0'],
		},
		{
			'name': 'Bug example 2 should be fixed',
			'input': ['9-hearts-0', '10-hearts-0', 'J-hearts-0', '8-hearts-0', '7-hearts-0'],
			'expected': ['7-hearts-0', '8-hearts-0', '9-hearts-0', '10-hearts-0', 'J-hearts-0'],
		},
	]
